        ...
        <div class="div_any">
            <div class="left div_any01">
                <div class="div_any_child">
                    <div class="div_any_title"><img src="../../assets/images/title_5.png">各医院门诊人次(人)</div>
                    <p id="histogramChart1" class="p_chart"></p>
                </div>
                <div class="div_any_child">
                    <div class="div_any_title"><img src="../../assets/images/title_6.png">各医院住院人次(人)</div>
                    <p id="histogramChart2" class="p_chart"></p>
                </div>
            </div>
            <div class="left div_any01">
                <div class="div_any_child">
                    <div class="div_any_title"><img src="../../assets/images/title_7.png">各医院医疗费用(元)</div>
                    <p id="lineChart1" class="p_chart"></p>
                </div>
                <div class="div_any_child">
                    <div class="div_any_title"><img src="../../assets/images/title_8.png">各医院体检人次(人)</div>
                    <p id="lineChart2" class="p_chart"></p>
                </div>
            </div>
            <div class="left div_any01">
                <div class="div_any_child">
                    <div class="div_any_title"><img src="../../assets/images/title_9.png">药占比(%)</div>
                    <p id="histogramChart3" class="p_chart"></p>
                </div>
                <div class="div_any_child">
                    <div class="div_any_title"><img src="../../assets/images/title_10.png">平均住院天数(天)</div>
                    <p id="histogramChart4" class="p_chart"></p>
                </div>
            </div>
            <div class="left div_any01">
                <div class="div_any_child">
                    <div class="div_any_title"><img src="../../assets/images/title_11.png">手术工作量(台)</div>
                    <p id="pieChart1" class="p_chart"></p>
                </div>
                <div class="div_any_child">
                    <div class="div_any_title"><img src="../../assets/images/title_12.png">床位数量分布(床)</div>
