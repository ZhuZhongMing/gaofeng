        ...
        <a-row>
          <a-col :span="24">
            <a-form-item label="设备编号" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['equipmentId', validatorRules.equipmentId]" :trigger-change="true" dictCode="mbp_dev_equipment,equipment_name,id" placeholder="请选择设备编号"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="设备变量名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['equipmentVarName', validatorRules.equipmentVarName]" placeholder="请输入设备变量名称"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="变量中文含义" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['dict', validatorRules.dict]" placeholder="请输入变量中文含义"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
    ...
    data () {
      return {
        ...
        validatorRules: {
          ...
          equipmentVarName: {
            rules: [
              { required: true, message: '请输入设备变量,匹配实时数据!'},
          ...
          dict: {
            rules: [
              { required: true, message: '请输入变量中文含义!'},
            ]
          },
        },
        url: {
          add: "/system/mbpDevEquipmentVar/add",
          edit: "/system/mbpDevEquipmentVar/edit",
          queryById: "/system/mbpDevEquipmentVar/queryById"
        }
      }
    },
    computed: {
