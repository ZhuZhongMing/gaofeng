...
public class MQTTConnentionUtil {
     ...
     * @return MQTT连接
     */
    public static MqttClient getMQTTConnect(MbpMqttConfig mqtt) throws MqttException { // String host, String clientId, String name, String password, String[] topic
     ...
     * @param sub
     */
    public static void reconnectionMQTT(MqttClient sampleClient, MbpMqttConfig mqtt, MqttCallBackUtil sub, IMbpMqttConfigService mbpMqttConfigService) {
