...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        //实时数据接口开放
        filterChainDefinitionMap.put("/system/mbpMqttData/TopTen", "anon");
        filterChainDefinitionMap.put("/system/mbpMqttData/monthCountData", "anon");
        filterChainDefinitionMap.put("/system/mbpMqttData/dayCountData", "anon");
        //生产设备接口开放
        filterChainDefinitionMap.put("/system/mbpDevEquipment/queryDevEquipmentList", "anon");
        filterChainDefinitionMap.put("/system/mbpDevEquipment/queryLastVarValue", "anon");
        filterChainDefinitionMap.put("/system/mbpDevEquipment/queryAllDevEquipmentList", "anon");
        //种植基地接口开放
        filterChainDefinitionMap.put("/system/mbpPlantationBase/listAll", "anon");
        //cas验证登录
